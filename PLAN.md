...
### 4.4 Décisions pour la phase 3 (2026-09-18)

- Worker `printed-labels-maker`, domaine `printed-labels.roma.moonmakers.fr`.
...
| Cloudflare : nom du worker         | `printed-labels-maker`                                                                                                                                                                                                                                                                                                              | décidé               |
| Cloudflare : déploiement           | par la build Git de Cloudflare (Workers Builds) depuis `main`, pas de job `deploy` dans GitHub Actions. La CI GitHub tourne sur la branche `dev` (et les PR vers `main`) ; on ne fusionne dans `main` qu'un `dev` vert (protection de branche conseillée), c'est ainsi que « jamais de déploiement avec une CI rouge » tient (§4.4) | décidé               |
...
| Cloudflare : compte cible          | celui du worker relié au repo ; aucun secret Cloudflare dans GitHub                                                                                                                                                                                                                                                                 | décidé               |
